		...
		<div class="row">
			<div id="contField" class="col s12 l10 offset-l1 z-depth-4">
				<div class="col s12 l3 center">
					...
					<a href="#" class="u_gig_p bold"><p class="z-depth-2"><i class="fa fa-camera" aria-hidden="true"></i>Photos</p></a>
					<a href="#" class="u_gig_v bold"><p class="z-depth-2"><i class="fa fa-youtube-play" aria-hidden="true"></i>Videos</p></a>
				</div>
				...
				<div id="contCont" class="col s12 l9 z-depth-1">
					<img class="poster" src="img/guitar.jpg" />
				</div>
			</div>
		</div>
<?php
