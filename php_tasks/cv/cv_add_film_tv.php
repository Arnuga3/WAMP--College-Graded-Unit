...
if (isset($_SESSION["mrBoss"])) {
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		$db->customQuery("INSERT INTO ai_films (ai_ID) VALUES ('')");
					
		$result = $db->customQuery("SELECT ai_ID FROM ai_films ORDER BY ai_ID DESC LIMIT 1");
		if ($result->num_rows == 1) {
			...
			$db->customQuery("INSERT INTO experience (cv_ID, film_tv_ID, theatre_ID, training_ID) VALUES ('$userIDDB', $lastID, 0, 0)");
