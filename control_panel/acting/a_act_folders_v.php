...
if (isset($_SESSION["mrBoss"])) {
	...
	<div class=\"sub_nav hide-on-med-and-down\">
		...
		<a class=\"z-depth-1 waves-effect waves-dark\" href=\"#\" onclick=\"checkIfCheckedEditVideo(0)\"><img src=\"../img/cpIcons/image_edit.png\" /><span>edit photo</span></a>
	...
	<div class=\"fixed-action-btn vertical click-to-toggle hide-on-large-only\" style=\"bottom: 24px; right: 24px;\">
		...
		<ul>
			...
			<li><span>edit photo</span><a class=\"btn-floating green\" onclick=\"checkIfCheckedEditVideo(0)\"><img src=\"../img/cpIcons/image_edit.png\" /></a></li>
		...
		foreach ($photos as $val) {
					echo "<!--Image Row in Control Panel(checkbox, name, image)-->
						<div class=\"flexVertCenter imgRow\">
							...
							<a class=\"videoPreview\" href='".$val["video_path"]."'>preview</a>
						</div>";
		}
		echo "<p id=\"error\"></p>";
	echo "</div>
