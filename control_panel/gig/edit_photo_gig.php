...
*/
	...
	echo "<!--ACTING PHOTOS-->
		...
		<div class=\"sub_nav hide-on-med-and-down\">
			<a class=\"waves-effect waves-dark z-depth-1\" onclick=\"saveChangesEdit(1)\"><img src=\"../img/cpIcons/diskette.png\" /><span>save</span></a>
		</div>
		
		<!--SAVE BTN MOB-->
		<div class=\"fixed-action-btn hide-on-large-only\" style=\"bottom: 24px; right: 24px;\">
			<a class=\"btn-floating btn-large waves-effect waves-light deep-orange darken-2\" onclick=\"saveChangesEdit(1)\"><img class=\"pencil\" src=\"../img/cpIcons/diskette.png\" /></a>
		</div>
