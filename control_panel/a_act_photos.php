...
if (isset($_SESSION["mrBoss"])) {
	...
	<div class=\"sub_nav hide-on-med-and-down\">
		...
		<a class=\"sb_delete z-depth-1 waves-effect waves-dark\" href=\"#\"  onclick=\"checkIfCheckedDel()\"><img src=\"../img/cpIcons/image_delete.png\" /><span>delete photo</span></a>
	...
	echo "</div>
			...
			//Footer modal
			foreach ($folders_indexed as $val) {
				echo "		<li><a class=\"foot_mod\" onclick=\"movePhotosAJAX('".$val."', getSelectedPhotos(), 0)\" href=\"#\">
								<div class=\"flexVertCenter\">
				...
				echo "		<li><a class=\"foot_mod\" onclick=\"movePhotosAJAX(prompt('Name the album'), getSelectedPhotos(), 0)\" href=\"#\">
							...
							<li><a class=\"foot_mod\" onclick=\"movePhotosAJAX('', getSelectedPhotos(), 0)\" href=\"#\">
								<div class=\"flexVertCenter\">
